...
class MissionTripsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('costa-rica')->id,
            'cost'                => '$1,500',
            'seats'               => null,
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('haiti')->id,
            'cost'                => '$1,500',
            'seats'               => null,
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('mexico')->id,
            'cost'                => '$1,650',
            'seats'               => null,
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('big-creek-ky')->id,
            'cost'                => '$100',
            'seats'               => null,
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('honduras')->id,
            'cost'                => null,
            'seats'               => null,
        ...
        DB::table('mission_trips')->insert([
            'mission_location_id' => MissionLocation::findByIdent('east-asia')->id,
            'cost'                => '$2,000',
            'seats'               => null,
