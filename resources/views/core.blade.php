...
@section('page')
    ...
    @include('partials.have_questions', ['class' => 'Section--lightGrey', 'contact' => 'Miles Creasman', 'email' => 'milesc@faithpromise.org', 'text' => 'If you still have questions about fpKids, please contact #email#'])
