...
@section('page')
    ...
    @introsection(['title' => 'Global Leadership Summit 2015'])
    <p>
    ...
    <div ng-show="answer == 'attender-pel' || answer == 'attender-blount'">
        <h5>Let's get you registered for the <span ng-show="answer == 'attender-pel'">Pellissippi</span><span ng-show="answer == 'attender-blount'">Blount</span> Campus</h5>
    ...
    <div ng-show="answer == 'non-attender-pel' || answer == 'non-attender-blount'">
        <h5>Let's get you registered for the <span ng-show="answer == 'non-attender-pel'">Pellissippi</span><span ng-show="answer == 'non-attender-blount'">Blount</span> Campus</h5>
        <p class="text-constrain-compact">If you're not a regular attender or part of the Core team at Faith Promise Church, please <a ng-show="answer == 'non-attender-pel'" href="https://www.willowcreek.com/events/leadership/reg1.asp?event_id=EV-LSS1408-MAIN-269" target="_blank">register here</a><a ng-show="answer == 'non-attender-blount'" href="https://www.willowcreek.com/events/leadership/reg1.asp?event_id=EV-LSS1408-MAIN-343" target="_blank">register here</a>.</p>
        <p><span class="link" ng-click="answer = null">Start Over</span></p>
    </div>
