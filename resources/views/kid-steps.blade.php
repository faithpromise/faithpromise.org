...
@section('page')
    ...
    <p>If you're interested in learning more about baptism's role in the life of believers, please visit our <a id="to_baptism_from_kidSteps" href="{{ route('baptism') }}">baptism page</a>.</p>
    @endintrosection
